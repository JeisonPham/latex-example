...
\fancyhead[R]{\small\textit{Module One}}
\fancyfoot[C]{\thepage}
...
% ============================================================
\newcommand{\doctitle}{Feature Name: Module One}
\newcommand{\docauthor}{Jason Pham}
\newcommand{\docreviewer}{Gojo}
...
This is the core of the document. Describe the solution in detail. It does something cool
